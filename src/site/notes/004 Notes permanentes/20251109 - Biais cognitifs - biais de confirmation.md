...
Quatre cartes sont présentées à des participants. Chacune porte, sur sa face visible, soit une lettre (D, F), soit un chiffre (7, 5). La consigne est claire : _« Quelles cartes devez-vous retourner pour vérifier la validité de la règle suivante : si une carte montre un D sur une face, alors son verso doit obligatoirement porter un 7 ? »_
